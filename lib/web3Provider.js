...
class Web3Provider {
  ...
  async initializeContracts() {
    ...
    const donationABI = DonationPlatformABI.abi || DonationPlatformABI;
    const nftABI = DonationNFTABI.abi || DonationNFTABI;
    const poolABI = SchoolPoolABI.abi || SchoolPoolABI;
